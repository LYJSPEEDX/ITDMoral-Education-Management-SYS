...
<form method="post">
  <table border="1" align="center" >
	...
	<tr>
		<td colspan="2" align="center"><input type="submit" onclick="_hmt.push(['_trackEvent', '注册', '新用户'])" value="提交"></td>
	</tr>
	<tr>
		<td colspan="2" align="center">请在此处<b>如实</b>填写个人资料<br>完成系统认证<br>*ERSD部员请勾选复选框<br><b>涉嫌破解该系统将会受到纪律检控</b></td>
	</tr>
	<tr>
